                  ...
                  <!-- Post -->
                    <%if(info != null){
                       for(int i = my_qnalist.size()-1; i >= 0; i--){ %>
	                     <article class="post" style="margin-bottom:0px" align=center>
	                        <header style="background-color : rgba(160, 160, 160, 0.075); " align=center>
	                           <div class="meta" style="padding-top: 30px;" align=center>
	                              <a  href="single.html" align=center><%=i+1%></a>      
	                           </div>
	                              <h1 style="margin-top: 30px;" align=center><%=my_qnalist.get(i).getMain() %></h1>
	                        </header>
	                                 
	                     <div class="jb-text">      
	                        <p align=center><%=my_qnalist.get(i).getQ_answer() %></p>
	                     </div>
